...
template <> constexpr inline auto Admin::qt_create_metaobjectdata<qt_meta_tag_ZN5AdminE_t>()
{
    ...
    QtMocHelpers::UintData qt_methods {
        // Slot 'on_ColMod_clicked'
        QtMocHelpers::SlotData<void()>(1, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_SuvMod_clicked'
        QtMocHelpers::SlotData<void()>(3, 2, QMC::AccessPrivate, QMetaType::Void),
        // Slot 'on_BackButt_clicked'
...
void Admin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->on_ColMod_clicked(); break;
        case 1: _t->on_SuvMod_clicked(); break;
        case 2: _t->on_BackButt_clicked(); break;
        default: ;
        }
    }
    (void)_a;
